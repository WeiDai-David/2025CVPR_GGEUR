...
def load_features(dataset_name, client_id, class_label):
    feature_path = f'./clip_office_caltech_all_features/{dataset_name}/client_{client_id}_class_{class_label}_original_features.npy'
...
# 处理amazon和caltech组合
process_and_save('amazon', 'caltech', output_dir)

# 处理amazon和dslr组合
process_and_save('amazon', 'dslr', output_dir)

# 处理amazon和webcam组合
process_and_save('amazon', 'webcam', output_dir)

# 处理amazon和webcam组合
process_and_save('caltech', 'dslr', output_dir)

# 处理amazon和webcam组合
process_and_save('caltech', 'webcam', output_dir)

# 处理amazon和webcam组合
process_and_save('dslr', 'webcam', output_dir)
