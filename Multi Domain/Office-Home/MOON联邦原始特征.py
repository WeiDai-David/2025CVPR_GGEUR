...
def federated_train_and_evaluate_moon(all_client_features, test_loaders, communication_rounds, local_epochs, batch_size=16, learning_rate=0.01, temperature=0.5, mu=1.0):
    ...
    report_path = './results/MOON_office_home_report.txt'
...
def main():
    ...
    # 保存精度最高的模型
    best_model_path = './model/MOON_office_home_global_model.pth'
    ...
    plt.legend()
    plt.savefig('./results/MOON_office_home_test_accuracy_plot.png')
    plt.show()
