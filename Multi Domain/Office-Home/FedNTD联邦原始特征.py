...
def federated_train_and_evaluate(all_client_features, test_loaders, communication_rounds, local_epochs, batch_size=16, learning_rate=0.01, temperature=1.0, beta=1.0, alpha=0.5):
    ...
    report_path = './results/FedNTD_original_report.txt'
...
def main():
    ...
    # 保存精度最高的模型
    best_model_path = './model/FedNTD_original_global_model.pth'
    ...
    plt.legend()
    plt.savefig('./results/FedNTD_original_test_accuracy_plot.png')
    plt.show()
