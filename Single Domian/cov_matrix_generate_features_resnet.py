...
def main():
    ...
    cov_matrix_dir = os.path.join(base_dir, f'resnet_alpha={alpha}_cov_matrix')  # 协方差矩阵文件夹路径
    initial_features_dir = os.path.join(base_dir, 'resnet_initial')  # ResNet 初始特征文件夹路径
    complete_features_dir = os.path.join(base_dir, f'resnet_alpha={alpha}_complete')  # 补全特征文件夹路径
