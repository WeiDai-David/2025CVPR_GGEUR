...
def main():
    ...
    output_dir = f'./CIFAR-100/features/alpha={alpha}_model/Fedavg_num_rounds={num_rounds}_epoch=1'
    ...
    print(f"Original feature model's CIFAR-100 test accuracy: {original_accuracy:.4f}")
    print(f"Original feature model's CIFAR-100 classification report:\n{original_report}")
    original_output_content = (
        f"Original feature model's CIFAR-100 test accuracy: {original_accuracy:.4f}\n"
        f"Original feature model's CIFAR-100 classification report:\n{original_report}\n"
        )
    ...
    print(f"Augmented feature model's CIFAR-100 test accuracy: {augmented_accuracy:.4f}")
    print(f"Augmented feature model's CIFAR-100 classification report:\n{augmented_report}")
    augmented_output_content = (
        f"Augmented feature model's CIFAR-100 test accuracy: {augmented_accuracy:.4f}\n"
        f"Augmented feature model's CIFAR-100 classification report:\n{augmented_report}\n"
        )
